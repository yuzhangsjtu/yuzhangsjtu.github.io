...
以结构化的形式编写提示词，可以得到更好的回答，常见的提示词框架有CO-STAR、TIDD-EC、CRISPE。
...
- [🔥中文 prompt 精选🔥](https://github.com/langgptai/wonderful-prompts)
